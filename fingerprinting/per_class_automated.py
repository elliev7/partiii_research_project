...
import pickle
import os
from functions import extract_results_limits_per_class_splits_avg
...
cov_euc, acc_euc, missed_euc, preds_euc, trues_euc = extract_results_limits_per_class_splits_avg(
...
cov_cos, acc_cos, missed_cos, preds_cos, trues_cos = extract_results_limits_per_class_splits_avg(
