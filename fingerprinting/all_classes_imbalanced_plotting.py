...
with open("/home/ev357/rds/hpc-work/results/all_classes/imb_embeddings_euclidean.pkl", "rb") as f:
    cov_euc, acc_euc, preds_euc, trues_euc = pickle.load(f)

plot_results_splits(cov_euc, acc_euc, samples, percentiles, 'imb_automated_all_classes_embeddings_euclidean_splits', percentile=True)
cov_avg_euc, cov_ci_euc, acc_avg_euc, acc_ci_euc = average_results_splits_with_ci(cov_euc, acc_euc, samples, percentiles)
save_results_to_csv(cov_avg_euc, cov_ci_euc, acc_avg_euc, acc_ci_euc, percentiles, samples, 'imb_embeddings_euclidean_avg')
...
with open("/home/ev357/rds/hpc-work/results/all_classes/imb_embeddings_cosine.pkl", "rb") as f:
    cov_cos, acc_cos, preds_cos, trues_cos = pickle.load(f)

plot_results_splits(cov_cos, acc_cos, samples, percentiles, 'imb_automated_all_classes_embeddings_cosine_splits', percentile=True)
cov_avg_cos, cov_ci_cos, acc_avg_cos, acc_ci_cos = average_results_splits_with_ci(cov_cos, acc_cos, samples, percentiles)
save_results_to_csv(cov_avg_cos, cov_ci_cos, acc_avg_cos, acc_ci_cos, percentiles, samples, 'imb_embeddings_cosine_avg')
