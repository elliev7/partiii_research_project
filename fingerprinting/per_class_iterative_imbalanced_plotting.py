...
def save_per_class_results_to_csv(coverage_results, accuracy_results, limits, sample_size, name):
    ...
    df.to_csv(f"/home/ev357/tcbench/src/fingerprinting/results/iterative_per_class/imb_{name}.csv")
...
with open("/home/ev357/rds/hpc-work/results/iterative/imb_embeddings_euclidean.pkl", "rb") as f:
    coverage_euc, accuracy_euc, preds_euc, trues_euc = pickle.load(f)

plot_results_per_class(coverage_euc, accuracy_euc, samples, percentiles, 'imb_iterative_per_class_embeddings_splits_avg', percentile=True)
for s in samples:
...
with open("/home/ev357/rds/hpc-work/results/iterative/imb_embeddings_cosine.pkl", "rb") as f:
    coverage_cos, accuracy_cos, preds_cos, trues_cos = pickle.load(f)

plot_results_per_class(coverage_cos, accuracy_cos, samples, percentiles, 'imb_iterative_per_class_embeddings_cosine_splits_avg', percentile=True)
for s in samples:
