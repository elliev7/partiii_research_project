...
with open("/home/ev357/rds/hpc-work/results/per_class/embeddings_euclidean.pkl", "rb") as f:
    coverage_euc, accuracy_euc, missed_euc, preds_euc, trues_euc = pickle.load(f)

plot_results_per_class(coverage_euc, accuracy_euc, samples, percentiles, 'automated_per_class_embeddings_splits_avg', percentile=True)
for s in samples:
...
with open("/home/ev357/rds/hpc-work/results/per_class/embeddings_cosine.pkl", "rb") as f:
    coverage_cos, accuracy_cos, missed_cos, preds_cos, trues_cos = pickle.load(f)

plot_results_per_class(coverage_cos, accuracy_cos, samples, percentiles, 'automated_per_class_embeddings_cosine_splits_avg', percentile=True)
for s in samples:
